...
REM :join
REM cd C:\
REM start wmic COMPUTERSYSTEM WHERE Name="%COMPUTERNAME%" CALL JoinDomainOrWorkgroup FJoinOptions=3 Name="Domain" UserName="it" Password="Password"
REM @echo off
REM color A
REM setlocal
...
:spice
cd C:\Users\itadmin\Desktop\New_Project\
start Msiexec.exe /I "Spiceworks Agent.msi" /q /l*v c:\spiceworksinstall.log SPICEWORKS_SERVER="IP" SPICEWORKS_AUTH_KEY="Hash" SPICEWORKS_PORT=444 ADDLOCAL=FeatureService,FeatureTray  /norestart
color A
setlocal
set "write=<nul set/p"
%write%=Patience, please
